 ...
 * metered — dropping to <=96 kbps takes the same track to 1.6 MB, roughly
 * tripling how many tracks a monthly allowance buys. Direct connections are
 * never capped; there is nothing to save.
 */
