...
/* EditorDialog — the full-screen, edge-to-edge editor used for add/edit of
              ...
              >
                ...
                <div className="flex-none border-b border-ink">
                  <div className={cn(column, 'flex items-center justify-between gap-3 py-3.5')}>
                    ...
                    <Dialog.Close
                      className="sw-focus flex-none cursor-pointer border-0 bg-transparent p-0 text-[22px] leading-none text-muted"
                      aria-label="Close"
                    >
                      ×
                    </Dialog.Close>
                ...
                <div className="sw-scroll flex-1 overflow-auto">
