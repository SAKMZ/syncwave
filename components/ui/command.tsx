...
/* shadcn-style Command wrappers over `cmdk`, restyled with the Syncwave
      ...
      <Dialog.Portal container={container}>
        ...
        <Dialog.Content
          ...
          className={cn(
            ...
            '[animation:sw-fade-in_160ms_ease-out]',
            pos,
          )}
        >
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn('sw-scroll max-h-80 overflow-x-hidden overflow-y-auto py-1', className)}
    {...props}
  />
));
